    ...
    <div class="tpl-content-wrapper">
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 双一流学校展示
                    </div>
        ...
        <%--<div id="operationLogs" style="display: none">--%>
            <%--<div class="tpl-portlet-components">--%>
                <%--<div class="portlet-title">--%>
                    <%--<div class="caption font-green bold">--%>
                        <%--<span class="am-icon-code"></span> 双一流学院展示--%>
                    <%--</div>--%>
                ...
                <%--<div class="tpl-block">--%>
                    <%--<div class="am-g">--%>
                        <%--<div class="am-u-sm-12">--%>
                            <%--<table id="table_id_college" class="am-table am-table-striped am-table-bordered display" style="width: 100%">--%>
                                <%--<thead>--%>
                                <%--<tr>--%>
                                    <%--<th >学院排名</th>--%>
                                    <%--<th >学院名称</th>--%>
            ...
            <%--</div>--%>
        <%--</div>--%>
            <div id="dataTableCollege" style="display: none;">
                <div class="tpl-portlet-components">
                    <div class="portlet-title">
                        <div class="caption font-green bold">
                            <span class="am-icon-code"></span> 双一流学院展示
                        ...
                        <div class="am-g">
                            <div class="am-u-sm-12 am-u-md-6">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <%--<button type="button" class="am-btn am-btn-default am-btn-warning" id="addClassify" onclick="initClassify()"><span class="am-icon-plus"></span>新增分类</button>--%>
                                        <button type="button" class="am-btn am-btn-default am-btn-success" id="addCollegePro" onclick="initAddCollegeData()"><span class="am-icon-plus"></span>新增数据</button>
                                    </div>
                                </div>
                            </div>
                        </div>
